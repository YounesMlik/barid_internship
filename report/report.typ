...
#import "my_style/lib.typ": appendices, project
...
#show: project.with(
  ...
  subtitle: [
    #text(size: 15pt)[Rapport de Projet de Fin d'Etudes]

    Présenté en vue de l’obtention du \
    Diplôme Universitaire De Technologie

    Filière : Infrastructures, Traitement Et Analyse de Données Massives (Big Data)

    #text(size: 15pt)[
      Présenté et Soutenu par : \
      Younes MLIK

      Encadré par : Pr. Khalid Qbouche
  ...
  company-logo: image("images/logo_usms.png"),
  mentors: (
    " (Internal)",
